...
////}
//
//void GameSaver::saveGame(const std::vector<ISaveable*>& objects, const std::string& filePath) {
//	std::ofstream fout(filePath);
//	if (fout.fail()) {
//		throw std::runtime_error("Cannot Save Game");
//	}
//	for (auto objectOfManager : objects) {
//		objectOfManager->save(fout);
//	}
//}
//
//void GameSaver::loadGame(const std::vector<ISaveable*>& objects, const std::string& filePath) {
//	std::ifstream fin(filePath);
//	if (fin.fail()) {
//		throw std::runtime_error("Cannot open Load file save");
//	}
//	for (auto objectOfManager : objects) {
//		objectOfManager->load(fin);
//	}
//}

PlayState* GameSaver::currentPlayState = nullptr;

void GameSaver::setPlayState(PlayState* playState) {
	currentPlayState = playState;
}

void GameSaver::saveGame(std::ostream& fileOut) {
	currentPlayState->save(fileOut);
}
